package es.jastxz.basic_translator.components;
...
import es.jastxz.basic_translator.repo.GlobalRequestRepo;
import es.jastxz.basic_translator.repo.UserRequestRepo;
